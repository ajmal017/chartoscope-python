...
class ZoneRecoveryProbe(Probe):
    ...
    def entrySetup(self, args):
        return (
               self._longTermMarketView != MarketView.Neutral) and self._longTermMarketView == self._midTermMarketView and self._midTermMarketView == self._shortTermMarketView
